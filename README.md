...
```bash
npm install --save nest-monk aws-sdk
```
...
import { AwsSdkModule } from 'nest-monk';
...
import { InjectAwsService } from 'nest-monk';
...
import { S3 } from 'aws-sdk';
import { createAwsServiceMock, createAwsServicePromisableSpy, getAwsServiceMock } from 'nest-monk/dist/testing';
import { S3ManagerService } from './s3-manager.service';
